...
(function iife(){
  var httpRequestUtility = {
    ...
    formatRequest: function(theHost,thePath){return {host:theHost,path:thePath}},
    formatRequest443: function(theHost,thePath){return {host:theHost,path:thePath,port:443}},
    formatRequest8080: function(theHost,thePath){return {host:theHost,path:thePath,port:8080}},
