...
(function iife(){
  var httpRequestUtility = {
    ...
    formatRequest: function(theHost,thePath){return {host:theHost,path:thePath,port:443,method:'GET'}},
    formatRequest443: function(theHost,thePath){return {host:theHost,path:thePath,port:443,method:'GET'}},
    formatRequest8080: function(theHost,thePath){return {host:theHost,path:thePath,port:8080,method:'GET'}},
    logResponse: function(value){console.log(value)},
